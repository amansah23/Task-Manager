  ...
  return (
    <div className='flex items-center gap-2 p-3'>
      <input
        ...
        checked={isChecked}
        onChange={onChange}
        className='w-4 h-4 text-blue-600 rounded-sm outline-none cursor-pointer focus:ring-blue-500 bg-gray-100 border-gray-300'
      />
      <p className={`text-sm ${isChecked ? 'line-through text-gray-500' : 'text-gray-700'}`}>
        {text}
      </p>
    </div>
  )
